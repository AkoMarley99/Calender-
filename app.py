...
class Month (db.Model):
    ...
    days_in_month = db.Column(db.String, nullable=False,)
    days_in_previous_month = db.Column(db.String, nullable=False,)
...
class MonthSchema(ma.Schema):
    class Meta: 
        fields = ('id', 'name', 'year', 'starty_day', 'days_in_month', 'days_in_previous_month', 'reminders')
...
def delete_month_by_id(id):
    ...
    return jsonify("Month successfully deleted")
...
def delete_reminder_by_id(id):
    ...
    return jsonify("Reminder successfully deleted")
